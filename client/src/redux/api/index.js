...
export const removeProductFromCart = (product, userId) => API.put(`/carts/remove/${userId}?productId=${product}`);
...
export const decrementProductUnit = (product, userId) => API.put(`/carts/decrement/${userId}?productId=${product}`);
...
export const incrementProductUnit = (product, userId) => API.put(`/carts/increment/${userId}?productId=${product}`)
