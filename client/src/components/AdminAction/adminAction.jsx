            ...
            <div class="w-2/6 mx-auto mt-28 mb-32 lg:mr-86  flex text-center items-center justify-center">
                <div class="bg-white shadow-md rounded my-6">
                    <table class="text-left w-full border-collapse">
                        <thead>
                            <tr>
                                <th class="py-4 px-6 bg-grey-lightest font-bold uppercase text-l text-grey-dark border-b border-grey-light">Admin Profile</th>
                                <th class="py-4 px-6 bg-grey-lightest font-bold uppercase text-l text-grey-dark border-b border-grey-light">Actions</th>
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 w-96 border-b border-gray-light  focus:outline-none hover:bg-gray-100 rounded ">Product Table</td>
                                <td class="py-4 px-6 border-b border-grey-light ">
                                    <Link to="/Admin">
                            ...
                            <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 border-b border-grey-light  focus:outline-none hover:bg-gray-200 rounded">Category Table</td>
                                <td class="py-4 px-6 border-b border-grey-light">
                                    <Link to="/categories">
                            ...
                            <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 border-b border-grey-light  focus:outline-none hover:bg-gray-200 rounded">User Table</td>
                                <td class="py-4 px-6 border-b border-grey-light">
                                    <Link to="/users">
                            ...
                            <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 border-b border-grey-light  focus:outline-none hover:bg-gray-200 rounded">Orders Table</td>
                                <td class="py-4 px-6 border-b border-grey-light">
                                    <Link to="/orders">
